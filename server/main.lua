...
ESX.RegisterUsableItem('fishingrod', function(source)
	...
	if baitquantity > 0 then
		...
		TriggerClientEvent('esx:showNotification', source, "Você não tem isca de peixe suficiente.")
	end
end)
...
ESX.RegisterUsableItem('fish', function(source)
	...
	TriggerClientEvent('esx:showNotification', source, 'Você cumeu 1x ~b~peixe~s~')
